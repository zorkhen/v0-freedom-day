            ...
            <div key={group.context} className="border border-neutral-200 p-7">
              ...
              <ul className="space-y-2">
                {group.indicators.map((indicator) => (
                  <li key={indicator} className="flex items-start gap-3 text-sm text-neutral-600 leading-relaxed">
        ...
        <div id="report" className="mt-14 bg-neutral-900 px-8 py-10 md:px-12">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-4">
              {[
                { country: "United States", line: "1-888-373-7888", org: "National Human Trafficking Hotline", text: "Text: 233733" },
                { country: "United Kingdom", line: "0800 0121 700", org: "Modern Slavery Helpline", text: null },
                { country: "Australia", line: "1800 021 221", org: "Australian Federal Police" , text: null },
                { country: "International", line: "report.unhcr.org", org: "UNHCR — Report exploitation", text: null },
              ].map((entry) => (
                <div key={entry.country} className="border border-neutral-700 px-5 py-4">
                  <p className="text-xs font-semibold text-red-400 uppercase tracking-wider mb-1">{entry.country}</p>
